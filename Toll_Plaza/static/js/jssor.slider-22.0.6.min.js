(function (j, f, c, i, d, l, g) {
    ...
    var b = j.$Jssor$ = new function () {
        ...
        h.Wg = function (d, a) {
            if (a)
                d.style.clip = "rect(" + c.round(a.$Top || a.D || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.C || 0) + "px)";
            else if (a !== g) {
        ...
        h.jd = function (l, m, x, q, z, A, n) {
            ...
            if (a.$Clip && b.Vg() && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.D && !a.$Clip.C && a.$Clip.$Right == n.$OriginalWidth && a.$Clip.$Bottom == n.$OriginalHeight)
                a.$Clip = i;
            return a
        }
    }
    ...
    j.$JssorSlideshowRunner$ = function (k, s, q, u, z) {
        ...
        f.lf = function () {
            ...
            ;
        if (b.wb() || b.$IsBrowserOpera() || z && b.$WebKitVersion() < 537)
            h = 16;
        n.call(f);
        m.call(f, -1e7, 1e7)
    }
